...
<script src="layui/layui.js"></script>
 ...
 layui.use('layer', function(){
     ...
     layer.open({
         ...
         area: ['400px', '200px'],
         maxmin: true ,
         title:'<h style="color:#000;font-size:15px;"><strong>本月蔬菜月销量</strong></h>',
         anim: 1,
         content: '<div style="width:400px;height:157px;background:rgb(95,184,120);text-align:center;line-height:154px;font-size:20px;">本月<span style="color:#009688;"><%=dd %></span>的采购量为：<span style="color:red;"><%=zz %><%=ff %></span></div>' 
       });
   }); 
</script>
<%
