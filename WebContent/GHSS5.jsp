...
function loginAdmin(){
	...
	$.ajax("http://www.sumengkx.com/ACPSample_B2C/POP5Servlet",{
		dataType: "json",
		//processData:false,
		data:{
			"time1":aa,
		...
		success:function(obj){
			...
			for(var i=0;i<obj.length;i++){
				html +='<table class="layui-table">';
				html +='<tr>';
				 html += '<td style="text-align:center;">' + obj[i].indent_ID  + '</td>';
                 html += '<td style="text-align:center;">' + obj[i].indent_Time + '</td>';
                 html += '<td style="text-align:center;">' + obj[i].courier_Name + '</td>';
                 html += '<a href="OLO2Servlet?id=' + obj[i].indent_ID + '"  class="layui-btn"style="padding: 0; margin: 0px ; width: 80px; font-size: 7px; height:25px; line-height: 25px ;" > <i class="layui-icon">&#xe705;</i>查看订单</a>';
				html +='</tr>';
