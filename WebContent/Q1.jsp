...
<body>
<form action="Q1Servlet" class="layui-form layui-form-pane" method="get">
<div class="nva">
	 	<fieldset>
 			<legend>请输入查询蔬菜的名称</legend>
				...
				<div class="layui-input-inline">
					<button type="submit" class="layui-btn" ><i class="layui-icon">&#xe615;</i>周销量查询</button>
				</div>
...
<tr>
	...
	<th style="text-align:center; background:rgb(0,150,136); color:#fff;"><strong>蔬菜单位</strong></th>
				...
				List<Order> list = dao.find2();
				for(Order order : list){
					String aa = order.getGreens_Name();
					int value = order.getNumber();
					String bb = order.getGreens_Unit();
%>
<tr>
