<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	response.setHeader("refresh", "60*10;URL=http://211.149.232.210/ACPSample_B2C/ListServlet");
    %>
...
<body >
<form action="LLServlet" method="get">
	<table  class="layui-table"   style="table-layout: fixed; width:auto;">

<thead>
 <tr >
    <th style="text-align:center; background:rgb(0,150,136); color:#fff;"><strong>编号</strong></th>
    <th style="display:none">类型</th>
    <th style="background:rgb(0,150,136); color:#fff; width:100px"><strong>名称</strong></th>
    ...
    <th style="text-align:center; background:rgb(0,150,136); color:#fff;"><strong>规格</strong></th>
