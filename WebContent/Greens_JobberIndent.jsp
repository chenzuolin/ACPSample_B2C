...
<form action="GreensJobberServlet" method="post">
	<%
		...
		for(int i=0;i<list1.size();i++){
			...
			if(list1.get(i).getIndent_Status().contains("正在处理")){
	...
	<td></td>
	<td>
	<INPUT TYPE="button"  class="layui-btn"  style="margin: 0; padding: 0; height: 30px; width: 60px; line-height: 30px;"  value="接收订单" onclick="window.location.href='GreensJobberServlet?id=<%=id %>'" id="<%=id %>" >
</td>
</tr>
