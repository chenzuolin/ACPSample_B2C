...
<table class="layui-table" style=" width:80%; margin-left:10%; table-layout: fixed;">
		<tr>
			...
			<th style="text-align:center; background:rgb(0,150,136); color:#fff;"><strong>是否推荐</strong></th>
...
<%
	...
	for(Greens greens : list){
		...
		String ee = greens.getGreens_Recommend();
...
%>
		...
		<tr>
			...
			<td style="text-align:center;"><a href="text2.jsp?bb=<%=bb %>" style="color:skyblue;"><i class="layui-icon">&#xe642;</i>修改</a></td>
		</tr>
		<%		
	}
%>
