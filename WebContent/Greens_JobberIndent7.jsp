...
<body>
  ...
  <div class="layui-card-header" style="background-color:#009688;color: white;font-size:15px;height: 30px ; line-height: 30px;">待处理订单
...
<table  class="layui-table"  style="table-layout: fixed; width: 100% ;">
	...
	for(Indent indent : list1){
		if(indent.getIndent_Status().contains("正在处理")){
...
%>
	<tr>
		...
		<td><a href="GreensJobberServlet1?id=<%=aa %>" class="layui-btn"style="padding: 0; margin: 0px ; width: 80px; font-size: 7px; height:25px; line-height: 25px ;" >接收订单</a>
		<%
}else{
}
	}
