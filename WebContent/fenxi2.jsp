...
<tr>
	...
	<th style="text-align:center; background:rgb(238,238,238);  color:#000;">蔬菜数量</th>
		<th style="text-align:center; background:rgb(238,238,238);  color:#000;">购买金额</th>
	
</tr>

<%	IndentDao dao=new IndentDao();
List<Indent> list=dao.findUserByIDmonth();
...
int id1=(Integer)request.getSession().getAttribute("id");
OrderDao dao9 = new OrderDao();
List<shuliang> list9 = dao9.findAll11(id1);
for(shuliang s : list9){
