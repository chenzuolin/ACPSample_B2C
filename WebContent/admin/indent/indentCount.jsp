...
layui.use(['table','layer','jquery'], function(){
  ...
  var ins1 = table.render({
    elem: '#test'
    ,url:'${pageContext.request.contextPath}/WineshopIndentCountSum'
    ,toolbar: '#toolbarDemo'
    ,title: '酒店下单次数总和表'
    ,height:550
    ,totalRow: true
    ,cols: [[
      ...
      ,{field:'wineshop_TuiJian', title:'推荐人', width:100,templet:function(d){
          return '<a class="layui-blue" href="./indentData.jsp?name='+d.wineshop_TuiJian+'">'+d.wineshop_TuiJian+'</a>';
      }}
    ...
    ,page: {
    	...
    	limits:[10,20,40,60,80,100,500,1000,2000,5000,10000],curr:1,groups:10,first:'首页',last:'尾页'
    	},request:{
