...
<style>
 ...
 <body>
<form class="layui-form layui-form-pane"  action="Greens_JobberIndentServlet1" method="post" >
<div class="layui-card">
  <div class="layui-card-header" style="background-color:#009688;color: white;font-size:15px;height: 30px ; line-height: 30px;">订单查询</div>
