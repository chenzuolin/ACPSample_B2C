    ...
    <div class="container">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a onclick="x_admin_show('个人信息','jibenziliao.jsp')">个人信息</a></dd>
              <dd><a onclick="x_admin_show('酒店资质','jiudianzizhi.jsp')">酒店资质</a></dd>
      ...
      <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="jibenziliao.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>基本资料</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="userinfo2.jsp">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>修改密码</cite>
                        </a>
                    </li>
