...
/**
 * Servlet implementation class WineshopIndexServlet1
 */
@WebServlet("/WineshopIndexServlet1")
public class WineshopIndexServlet1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WineshopIndexServlet1() {
        super();
