...
/**
 * Servlet implementation class GreensUPServlet
 */
@WebServlet("/GreensUPServlet")
public class GreensUPServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GreensUPServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		*/
		...
		out.print("<script langage='javascript'>alert('ÐÞ¸Ä³É¹¦£¡£¡');window.location.href='ListServlet1'</script>");
