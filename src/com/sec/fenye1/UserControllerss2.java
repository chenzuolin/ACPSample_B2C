...
/**
 * Servlet implementation class UserControllerss2
 */
@WebServlet("/UserControllerss2")
public class UserControllerss2 extends HttpServlet {
...
String currentPage =request.getParameter("currentPage");
		...
		System.out.println(page.getshowuser());
		request.setAttribute("page", page);	
		request.getRequestDispatcher("S2.jsp").forward(request, response);
		}
	}
