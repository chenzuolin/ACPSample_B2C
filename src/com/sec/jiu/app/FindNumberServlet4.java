...
/**
 * Servlet implementation class FindNumberServlet4
 */
@WebServlet("/FindNumberServlet4")
public class FindNumberServlet4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindNumberServlet4() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Wineshop> select = dao1.Select(Wineshop_username);
		int Wineshop_ID = 0;
