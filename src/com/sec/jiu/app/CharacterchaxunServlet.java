...
/**
 * Servlet implementation class CharacterchaxunServlet
 */
@WebServlet("/CharacterchaxunServlet")
public class CharacterchaxunServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CharacterchaxunServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Greens_Character> a = dao.findAll();
