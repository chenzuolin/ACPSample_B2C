...
/**
 * Servlet implementation class BB55Servlet
 */
@WebServlet("/BB55Servlet")
public class BB55Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Indent> list = dao.findUserByIDsss("正在处理",as,bs);
