...
/**
 * Servlet implementation class FindNumberServlet2
 */
@WebServlet("/FindNumberServlet2")
public class FindNumberServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindNumberServlet2() {
        super();
