...
/**
 * Servlet implementation class GG6Servlet
 */
@WebServlet("/GG6Servlet")
public class GG6Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String a0 = request.getParameter("aa");
		GreensDao dao0 = new GreensDao();
		int a00 = dao0.findUserByID2(a0);
		int aa = 0;
		...
		l = l/31;
		l1 = l1/31;
		float a2 = (float)(Math.round(a1*100))/100;
		float b2 = (float)(Math.round(b1*100))/100;
		float c2 = (float)(Math.round(c1*100))/100;
		float d2 = (float)(Math.round(d1*100))/100;
		float e2 = (float)(Math.round(e1*100))/100;
		float f2 = (float)(Math.round(f1*100))/100;
		float g2 = (float)(Math.round(g1*100))/100;
		float h2 = (float)(Math.round(h1*100))/100;
		float i2 = (float)(Math.round(i1*100))/100;
		float j2 = (float)(Math.round(j1*100))/100;
		float k2 = (float)(Math.round(k1*100))/100;
		float l2 = (float)(Math.round(l1*100))/100;
