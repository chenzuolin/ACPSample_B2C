...
/**
 * Servlet implementation class NewJDZCServlet
 */
@WebServlet("/NewJDZCServlet")
public class NewJDZCServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NewJDZCServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		wineshop.setWineshop_Nature("");
		wineshop.setWineshop_QQ("");
		wineshop.setWineshop_WeChat("");
		wineshop.setWineshop_Number("");
		wineshop.setWineshop_Time("");
		wineshop.setWineshop_TimeNight("");
