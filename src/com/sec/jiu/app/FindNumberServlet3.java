...
/**
 * Servlet implementation class FindNumberServlet3
 */
@WebServlet("/FindNumberServlet3")
public class FindNumberServlet3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindNumberServlet3() {
        super();
