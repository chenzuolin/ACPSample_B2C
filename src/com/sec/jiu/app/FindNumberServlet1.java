...
/**
 * Servlet implementation class FindNumberServlet1
 */
@WebServlet("/FindNumberServlet1")
public class FindNumberServlet1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindNumberServlet1() {
        super();
