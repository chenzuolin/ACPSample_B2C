...
/**
 * Servlet implementation class zhoufenxiServlet
 */
@WebServlet("/zhoufenxiServlet")
public class zhoufenxiServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public zhoufenxiServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Indent> list = dao.findUserByIDweek1(a);
