...
/**
 * Servlet implementation class GreensNumberServlet
 */
@WebServlet("/GreensNumberServlet")
public class GreensNumberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GreensNumberServlet() {
        super();
