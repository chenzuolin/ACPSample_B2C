...
/**
 * Servlet implementation class WinxinPay1
 */
@WebServlet("/WinxinPay1")
public class WinxinPay1 extends HttpServlet {
...
//			int x = Integer.parseInt(tradeMoney);
		...
		int b = (int) (Float.valueOf(a)*100);
			...
			String notify_url = "http://www.sumengkx.com/ACPSample_B2C/NoServlet100";// 回调地址 必须能直接访问 不是二级域名也可以
				...
				if ("SUCCESS".equals(returnCode)) {
					...
					if ("SUCCESS".equals(resultCode)) {
						 ...
						 PriceDao dao = new PriceDao();
			                ...
			                price.setIndent_PayID(out_trade_no);
